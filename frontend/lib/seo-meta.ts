...
export const SEO_META: Record<string, SeoEntry> = {
  ...
  "/investors": { t: "Top Insiders: Corporate Insiders, Congress & Famous Investors Graded | InsiderBuying.com", d: "Every insider we track on one page: corporate insiders from Form 4 filings, members of Congress from STOCK Act disclosures and the most-watched funds from 13Fs, each with a Performance Grade ranked against their peers, their last ten trades and current holdings." },
