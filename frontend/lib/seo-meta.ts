...
export const SEO_META: Record<string, SeoEntry> = {
  "/": { t: "Real-Time Insider Buying Activity & Signals | InsiderBuying.com", d: "InsiderBuying.com tracks when CEOs, CFOs, and directors buy their own company's stock — and scores every transaction with the proprietary Insider Quality Score. The smartest signal in the market, made actionable." },
  "/about": { t: "About Us | Real-Time Insider Trade Tracking | InsiderBuying.com", d: "Learn how InsiderBuying.com empowers retail investors with real-time SEC Form 4 insider trade tracking, proprietary IQS analytics, and market research." },
  ...
  "/advertorials/this-time-is-different": { t: "Contrarian Market Analysis: Insider Signals | InsiderBuying.com", d: "Explore our deep-dive macro analysis on why executive insider buying patterns signal major opportunities in today's volatile stock market." },
  ...
  "/companies": { t: "Company Directory & Stock Ticker Database | InsiderBuying.com", d: "Browse our comprehensive directory of publicly traded companies. Track stock tickers, C-suite Form 4 transactions, and insider ownership data." },
  "/congressional-trades": { t: "Congressional Stock Trades & Disclosures | InsiderBuying.com", d: "Track stock purchases and sales by politicians in real time. Access House and Senate financial disclosures to see where politicians invest." },
  "/contact": { t: "Contact Us & Customer Support | InsiderBuying.com", d: "Get in touch with the InsiderBuying.com team. Have questions, feedback, or media inquiries? Contact our editorial and support staff today." },
  "/disclaimer": { t: "Financial & Legal Disclaimer | InsiderBuying.com", d: "Read the official financial and legal disclaimers for InsiderBuying.com. Our platform provides data-driven research and SEC Form 4 summaries." },
  "/dividends": { t: "Stock Dividend Calendar & Insider Yields | InsiderBuying.com", d: "Track upcoming stock dividend dates, dividend yields, and payouts. Discover high-yielding dividend stocks favored by corporate insiders." },
  "/earnings": { t: "Earnings Reports, EPS Surprises & Calendar | InsiderBuying.com", d: "Track real-time stock earnings reports, EPS actuals vs. estimates, and post-earnings price swings combined with insider trading signals." },
  "/editorial": { t: "Editorial Guidelines & Research Standards | InsiderBuying.com", d: "Learn about our rigorous financial editorial standards, methodology, and commitment to objective SEC Form 4 data analysis and reporting." },
  "/government-contracts": { t: "Federal Government Contracts & Stock Impact | InsiderBuying.com", d: "Track US government contract awards to public companies. Analyze how federal Defense and IT contracts correlate with insider buying activity." },
  "/heatmaps/market": { t: "Real-Time Market Heatmap & Sector Trends | InsiderBuying.com", d: "Visualize stock market performance and sector momentum in real time with interactive heatmaps. Spot insider concentration across industries." },
  "/insiders/buy-sell": { t: "Insider Buying vs Selling Activity & Ratios | InsiderBuying.com", d: "Analyze real-time insider buying vs. selling ratios and Form 4 transaction trends. See whether C-suite executives are accumulating or dumping shares." },
  "/insiders/hot": { t: "Hot Insider Stocks & Top Executive Trades | InsiderBuying.com", d: "Discover hot stocks experiencing high-conviction C-suite insider buying. Track top executive trades, cluster buys, and surging Form 4 activity today." },
  "/insights": { t: "Market Insights & Insider Trading Research | InsiderBuying.com", d: "Read data-backed market insights, macro analysis, and forensic insider trade breakdowns. Make informed investments with deep-dive financial research." },
  ...
  "/data": { t: "Data Articles: Most-Bought Stocks, Top Analysts & Hedge Funds | InsiderBuying.com", d: "Evergreen data pages built from live SEC Form 4, 13F and analyst-rating data: what insiders are buying and selling most, the best-performing analysts and hedge funds. Refreshed automatically." },
  "/ipos": { t: "IPO Calendar: Recent IPOs & Performance Since Listing | InsiderBuying.com", d: "Every IPO from the last 90 days with its offering price, current price and return since listing, updated nightly — plus a flag when insiders have bought stock on the open market since the debut." },
  "/cqs-index": { t: "Congress Quality Score (CQS) Index: Stocks Members of Congress Are Buying | InsiderBuying.com", d: "Every stock ranked by how strong the congressional buying signal on it is right now, scored 0-100 from STOCK Act disclosures: how many members are buying, how large the positions are, whether the cluster is bipartisan, committee jurisdiction, federal contract alignment and what the buyers' own track records look like." },
  "/politicians": { t: "Congress Wealth Tracker: Disclosed Portfolio Growth by Member | InsiderBuying.com", d: "Every member of Congress ranked by the estimated growth of their disclosed stock portfolio, rebuilt trade by trade from STOCK Act filings: 90-day and all-time returns, hit rates, badges, current holdings and what they paid." },
  "/insiders": { t: "Top Insiders: Corporate Insiders, Congress & Famous Investors Graded | InsiderBuying.com", d: "Every insider we track on one page: corporate insiders from Form 4 filings, members of Congress from STOCK Act disclosures and the most-watched funds from 13Fs, each with a Performance Grade ranked against their peers, their last ten trades and current holdings." },
  "/insiders/leaderboard": { t: "Insider Leaderboard: Every Form 4 Buyer Ranked by Dollars Bought | InsiderBuying.com", d: "Every corporate insider who filed an open-market purchase, ranked by dollars bought, with role, country and company filters and each buyer's track record." },
  "/index-ibcx": { t: "InsiderBuying Conviction Index (IBCX): Rules, Level & Constituents | InsiderBuying.com", d: "A rules-based index of companies that clear a downside-protection screen and show real insider conviction, built only from public filings and as-reported statements using point-in-time data, reconstituted quarterly." },
  "/learn/insider-buying": { t: "How to Use Insider Buying Data to Trade | InsiderBuying.com", d: "Learn how to read SEC Form 4 filings, spot high-conviction executive stock buys, and use insider trading data to improve your stock market returns." },
  "/market-data/top-gainers": { t: "Top Gaining Stocks Today & Insider Activity | InsiderBuying.com", d: "See today's top gaining stocks in real time. Combine price momentum with SEC Form 4 insider buying signals to spot breakout stock opportunities." },
  "/market-data/top-losers": { t: "Top Losing Stocks Today & Insider Buys | InsiderBuying.com", d: "Track today's biggest stock price drops and dip-buying C-suite executives. Discover contrarian stock opportunities backed by Form 4 filings." },
  "/movers": { t: "Daily Stock Market Movers & Insider Trades | InsiderBuying.com", d: "Monitor daily stock market movers, volume surges, and executive trading activity. Track where smart money and corporate insiders are positioning." },
  "/premium": { t: "InsiderBuying.com Premium | Real-Time IQS Alerts & Data", d: "Upgrade to InsiderBuying.com Premium for real-time IQS trade alerts, deep-dive Form 4 research, historical insider win rates, and custom portfolio tracking." },
  "/reports": { t: "Insider Trading Reports & Stock Research | InsiderBuying.com", d: "Access in-depth insider trading reports, Form 4 market breakdowns, and sector analyses. Discover executive sentiment across top public equities." },
  ...
  "/reports/cta/KGC": { t: "Kinross Gold (KGC) Insider Trade Report | InsiderBuying.com", d: "Review real-time insider buying and selling activity for Kinross Gold Corp (KGC). Access Form 4 disclosures, executive transactions, and IQS ratings." },
  "/reports/cta/MRNA": { t: "Moderna (MRNA) Insider Buying Report & Data | InsiderBuying.com", d: "Analyze Moderna Inc. (MRNA) insider trade activity and SEC Form 4 filings. Track executive buys, insider ownership changes, and IQS stock signals." },
  ...
  "/reports/cta/PAAS": { t: "Pan American Silver (PAAS) Insider Report | InsiderBuying.com", d: "Analyze Pan American Silver Corp (PAAS) executive insider buys and sales. Access real-time Form 4 disclosures, C-suite trades, and IQS ratings." },
  "/reports/cta/TOP5": { t: "Top 5 Insider Buying Stocks Report | InsiderBuying.com", d: "Discover the top 5 stocks seeing heavy C-suite insider buying this month. Access detailed SEC Form 4 analysis, executive conviction, and IQS ratings." },
  ...
  "/reports/monthly/2026-01": { t: "January 2026 Insider Buying Monthly Report | InsiderBuying.com", d: "Review top executive insider trades and Form 4 filing trends from January 2026. Analyze high-conviction C-suite purchases across all major sectors." },
  "/reports/monthly/2026-02": { t: "February 2026 Insider Buying Monthly Report | InsiderBuying.com", d: "Explore executive stock purchases and SEC Form 4 transaction trends for February 2026. Discover top insider buys, cluster activity, and market insights." },
  "/reports/monthly/2026-03": { t: "March 2026 Insider Trading Monthly Report | InsiderBuying.com", d: "Access the March 2026 insider trading report. Analyze C-suite stock accumulation, major Form 4 disclosures, and sector-wide executive sentiment." },
  "/reports/monthly/2026-04": { t: "April 2026 Insider Buying Monthly Report | InsiderBuying.com", d: "Review executive stock buying trends and SEC Form 4 filings from April 2026. Spot high-conviction insider trades and top-performing equities." },
  "/reports/monthly/2026-05": { t: "May 2026 Insider Trading Monthly Report | InsiderBuying.com", d: "Explore C-suite executive trades and SEC Form 4 filings for May 2026. Access detailed insider buying analysis, sector trends, and IQS ratings." },
  "/screener": { t: "Insider Buying Stock Screener & Filter | InsiderBuying.com", d: "Filter and screen public stocks by C-suite insider buying, Form 4 transaction sizes, executive roles, and proprietary IQS ratings in real time." },
  "/sectors": { t: "Market Sectors & Industry Insider Buying | InsiderBuying.com", d: "Explore insider buying and selling trends across major market sectors. Track C-suite transaction activity in Tech, Healthcare, Energy, and Finance." },
  "/short-interest": { t: "High Short Interest Stocks & Insider Buys | InsiderBuying.com", d: "Discover heavily shorted stocks seeing unexpected C-suite insider buying. Track high short interest equities backed by Form 4 executive accumulation." },
  ...
  "/stock-lists": { t: "Curated Insider Stock Lists & Screeners | InsiderBuying.com", d: "Browse curated stock lists filtered by C-suite insider buying, sector focus, dividend yield, and market cap. Discover high-conviction equities." },
  ...
  "/stock-lists/canada": { t: "Canadian Stocks Insider Buying & TSX Trades | InsiderBuying.com", d: "Monitor insider buying and selling activity across Canadian stocks on the TSX and TSXV. Track Form 4 and SEDI executive trade disclosures." },
  "/stock-lists/eric-sprott": { t: "Eric Sprott Stock Portfolio & Mining Trades | InsiderBuying.com", d: "Track billionaire investor Eric Sprott's stock holdings and mining disclosures. See recent gold and silver stock purchases and insider stakes." },
  "/stock-lists/faang": { t: "FAANG Stock Insider Trading & Big Tech Buys | InsiderBuying.com", d: "Track executive insider buying and selling across FAANG and major Big Tech stocks. Review C-suite Form 4 filings for Meta, Apple, Nvidia, and more." },
  "/stock-lists/germany": { t: "German Stocks Insider Buying & BaFin Trades | InsiderBuying.com", d: "Monitor insider buying and selling across German stocks. Track BaFin director dealings and executive trade disclosures on the Frankfurt exchange." },
  "/stock-lists/gold": { t: "Gold Stocks Insider Buying & Mining Trades | InsiderBuying.com", d: "Discover gold mining stocks seeing significant executive insider purchases. Access real-time SEC Form 4 trade disclosures and industry trends." },
  "/stock-lists/hot-sectors": { t: "Hot Sectors: Volume Flow Heat Map & Insider Buying | InsiderBuying.com", d: "See where money is flowing today: all 11 GICS sectors plus Biotech and Crypto ranked by net trading-volume flow, with top performers and insider $ flow." },
  "/stock-lists/iqs-top-picks": { t: "IQS Top Stock Picks & Insider Ratings | InsiderBuying.com", d: "Discover top-rated stocks selected by our proprietary IQS scoring system. Combine high-conviction C-suite insider buying with quantitative data." },
  "/stock-lists/jeff-bezos": { t: "Jeff Bezos Stock Trades & Amazon Holdings | InsiderBuying.com", d: "Track Jeff Bezos' stock transactions, Amazon (AMZN) Form 4 disclosures, and insider selling activity. Stay updated on executive stock moves." },
  "/stock-lists/large-cap": { t: "Large-Cap Stocks with C-Suite Insider Buys | InsiderBuying.com", d: "Monitor large-cap stocks seeing high-conviction executive insider buying. Track S&P 500 C-suite Form 4 filings and corporate sentiment." },
  "/stock-lists/metals-and-mining": { t: "Metals & Mining Stocks Insider Buying | InsiderBuying.com", d: "Track insider buying across metals and mining stocks. Review Form 4 filings for gold, silver, copper, and critical mineral mining executives." },
  "/stock-lists/oil": { t: "Oil & Energy Stocks Insider Buying | InsiderBuying.com", d: "Discover oil and gas stocks seeing heavy executive insider buying. Track C-suite Form 4 transactions across the energy sector in real time." },
  "/stock-lists/penny-stocks": { t: "Penny Stocks with Heavy Insider Buying | InsiderBuying.com", d: "Find low-priced penny stocks experiencing significant C-suite insider accumulation. Filter micro-cap equities by Form 4 buys and IQS scores." },
  ...
  "/stock-lists/small-cap": { t: "Small-Cap Stocks with C-Suite Insider Buys | InsiderBuying.com", d: "Find promising small-cap stocks seeing significant executive insider accumulation. Filter high-upside equities by Form 4 transactions and IQS ratings." },
  "/stock-lists/tech": { t: "Tech Stocks Insider Buying & C-Suite Trades | InsiderBuying.com", d: "Track technology stocks and software companies receiving major executive insider buys. Review real-time Form 4 filings and C-suite accumulation." },
  ...
  "/stock-lists/warren-buffett": { t: "Warren Buffett Stock Portfolio & 13F Trades | InsiderBuying.com", d: "Track Warren Buffett's stock portfolio and Berkshire Hathaway 13F filings. Monitor top holdings, recent stock purchases, and insider activity." },
...
export function pageMetadata(
  ...
  const title = e?.t ?? fallback?.title ?? "InsiderBuying.com — Live SEC Form 4 + Congressional Trades";
  const description =
    e?.d ??
