...
export const SEO_META: Record<string, SeoEntry> = {
  ...
  "/ipos": { t: "Upcoming IPOs Calendar & Insider Tracking | InsiderBuying.com", d: "Track upcoming initial public offerings (IPOs), filing dates, and insider lockup expirations. Monitor executive activity for newly public companies." },
