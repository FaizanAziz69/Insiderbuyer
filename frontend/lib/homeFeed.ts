...
/*  2026-09-22: repointed to the Michael Burry copper story (client X tip). */
export const HERO_PIN: string | null =
  "editorial-michael-burry-copper-ero-position-2026-09-22";
