    ...
    columns: [
      {
        title: "Topics",
        links: [
          { label: "AI", href: "/news?tag=ai", icon: Sparkles },
          { label: "Analyst Ratings", href: "/news?tag=analyst-ratings", icon: ShieldCheck },
          { label: "Biotech", href: "/news?tag=biotech", icon: FlaskConical },
          { label: "Dividends", href: "/news?tag=dividends", icon: Coins },
          { label: "Earnings", href: "/news?tag=earnings", icon: BarChart3 },
          { label: "Electric Vehicles", href: "/news?tag=ev", icon: TrendingUp },
          { label: "ETFs", href: "/news?tag=etf", icon: Briefcase },
          { label: "Insider Trades", href: "/news?tag=insider-trades", icon: Activity },
        ],
      },
      {
        title: "More Topics",
        links: [
          { label: "IPOs", href: "/news?tag=ipo", icon: Rocket },
          { label: "Macro", href: "/news?tag=macro", icon: Globe2 },
          { label: "Markets", href: "/news?tag=markets", icon: LineChart },
          { label: "Mergers & Acquisitions", href: "/news?tag=ma", icon: Briefcase },
          { label: "Rare Earth Minerals", href: "/news?tag=rare-earth", icon: Gem },
          { label: "Semiconductors", href: "/news?tag=semis", icon: Cpu },
          { label: "Short Interest", href: "/news?tag=short-interest", icon: TrendingUp },
          { label: "Space", href: "/news?tag=space", icon: Plane },
        ],
      },
      {
        title: "Sections",
