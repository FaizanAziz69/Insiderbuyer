      ...
      <article className="min-w-0">
        ...
        {isLoading || !post ? (
          ...
          >
            ...
            {/* Key Points — MarketBeat-style takeaway box */}
            <div
              className="mt-6 rounded-lg p-5"
              style={{
                background:
                  "linear-gradient(135deg, color-mix(in srgb, var(--accent) 7%, var(--bg-2)) 0%, var(--bg-2) 100%)",
            ...
            >
              ...
              <ul className="space-y-2 text-[14px] leading-relaxed">
                <li className="flex gap-2">
                  ...
                  <span className="text-soft">{post.summary}</span>
                </li>
                {post.iqsAtGeneration !== null &&
                  post.iqsAtGeneration !== undefined && (
                    <li className="flex gap-2">
                      <span className="text-accent font-bold flex-shrink-0">▪</span>
                      <span className="text-soft">
                        {post.ticker ? (
                          <>
                            <Link
                              href={`/companies/${encodeURIComponent(post.ticker)}`}
                          ...
                          "The top name in this story scores "
                        )}
                ...
                <li className="flex gap-2">
                  <span className="text-accent font-bold flex-shrink-0">▪</span>
                  <span className="text-soft">
                    Data sourced from live SEC Form 4 filings
                    {post.sector ? (
