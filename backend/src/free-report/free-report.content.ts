...
export const COVER = {
  ...
  sub2: 'Plus 3 Stocks Insiders Are Buying Right Now',
...
export const PART_ONE = {
  ...
  blocks: [
    ...
    {
      kind: 'p',
      text: 'The catch? Thousands of them are filed every week, buried in legal formatting and mixed with noise. That’s where most investors give up, and that is where the edge begins.',
    },
...
export const PART_TWO = {
  ...
  intro:
    'All insider transactions and analyst figures below are drawn from public filings and published research coverage as of mid-September 2026. Verify current data at InsiderBuying.com before making any decision, because filings update daily.',
  stocks: [
    {
      number: 1,
    ...
    },
    {
      ...
      qa: [
        ...
        {
          q: '4. Do analysts cover the stock?',
          a: 'Yes. Roughly 8 to 18 analysts cover it, depending on the tally, with a consensus rating of Buy/Strong Buy. Even after post-acquisition target cuts in early September (BTIG to $36, Citizens to $47, BMO to $27, Wells Fargo and Canaccord maintaining Buy), the published targets sit dramatically above the ~$18.50 share price, and several imply 60%+ upside. Analysts and insiders are aligned; the price is the outlier.',
        },
      ],
    },
  ] as StockSection[],
...
export const CLOSE = {
  ...
  features: [
    ['IQ Score™ (Insider Quality Score)', 'Our 0 to 100 conviction grade on any stock, weighing who bought, how, how much, and how many. Unlimited searches, every ticker.'],
    ['Top Buys Tracker', 'A live, ranked feed of the most significant insider purchases on the market, updated as filings drop.'],
    ['Cluster-Buy Screener', 'Instantly surfaces stocks where multiple insiders are buying in tight windows. It is the strongest pattern in the discipline, before it makes headlines (it usually never does).'],
    ['Real-Time Insider Alerts', 'The moment an insider moves on any stock you own or watch, you know, by push and email.'],
    ['Congress Trades', 'Track disclosed trades by U.S. politicians alongside corporate insiders, for the full smart-money picture in one place.'],
