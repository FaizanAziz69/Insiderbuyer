...
export const ROSTER: RosterEntry[] = [
  ...
  { slug: 'baillie-gifford', person: 'Baillie Gifford', firm: 'Baillie Gifford & Co', cik: '0001088876', categories: ['growth', 'longterm'], active: true },
  ...
  { slug: 'charles-brandes', person: 'Charles Brandes', firm: 'Brandes Investment Partners', cik: '0001542551', categories: ['value'], active: true },
  ...
  { slug: 'david-einhorn', person: 'David Einhorn', firm: 'Greenlight Capital', cik: '0001449674', categories: ['value', 'short'], active: true },
